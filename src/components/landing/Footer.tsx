        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Platform arisan online terpercaya dengan sistem keamanan terbaik dan fitur lengkap.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#testimonials" className="hover:text-primary transition-colors">Testimoni</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href={`tel:+${siteConfig.contact.whatsapp}`} className="hover:text-primary transition-colors">
